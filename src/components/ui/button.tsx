  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white hover:shadow-glow hover:scale-105 transition-bounce font-semibold",
        crypto: "gradient-crypto text-white hover:shadow-elevated hover:scale-105 transition-bounce",
        encrypted: "gradient-encrypted text-encrypted-foreground hover:bg-encrypted/90 shadow-card",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-card",
        wallet: "bg-accent text-accent-foreground hover:bg-accent/90 border border-accent/20 shadow-card",
      },
      size: {
